...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHCsgUtils_Statics::NewProp_GModel = { "GModel", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHCsgUtils, GModel), Z_Construct_UClass_UModel, METADATA_PARAMS(Z_Construct_UClass_UHCsgUtils_Statics::NewProp_GModel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHCsgUtils_Statics::NewProp_GModel_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHCsgUtils_Statics::NewProp_TempModel = { "TempModel", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHCsgUtils, TempModel), Z_Construct_UClass_UModel, METADATA_PARAMS(Z_Construct_UClass_UHCsgUtils_Statics::NewProp_TempModel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHCsgUtils_Statics::NewProp_TempModel_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HCsgUtils_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HCsgUtils_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHCsgUtils, UHCsgUtils::StaticClass, TEXT("UHCsgUtils"), &Z_Registration_Info_UClass_UHCsgUtils, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHCsgUtils), 2009424267U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HCsgUtils_h_3120227734(TEXT("/Script/HoudiniEngine"),
		Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HCsgUtils_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HCsgUtils_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
