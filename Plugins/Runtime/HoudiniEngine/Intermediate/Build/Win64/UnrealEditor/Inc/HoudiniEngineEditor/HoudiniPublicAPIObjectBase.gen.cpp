...
// End Cross Module References
	...
	static UEnum* EHoudiniPublicAPIErrorLogOption_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EHoudiniPublicAPIErrorLogOption.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HoudiniEngineEditor_EHoudiniPublicAPIErrorLogOption, Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("EHoudiniPublicAPIErrorLogOption"));
		}
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_GetLastErrorMessage_Statics::NewProp_OutLastErrorMessage = { "OutLastErrorMessage", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HoudiniPublicAPIObjectBase_eventGetLastErrorMessage_Parms, OutLastErrorMessage), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_GetLastErrorMessage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HoudiniPublicAPIObjectBase_eventGetLastErrorMessage_Parms), &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_GetLastErrorMessage_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_IsLoggingErrors_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HoudiniPublicAPIObjectBase_eventIsLoggingErrors_Parms), &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_IsLoggingErrors_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetErrorMessage_Statics::NewProp_InErrorMessage = { "InErrorMessage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HoudiniPublicAPIObjectBase_eventSetErrorMessage_Parms, InErrorMessage), METADATA_PARAMS(Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetErrorMessage_Statics::NewProp_InErrorMessage_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetErrorMessage_Statics::NewProp_InErrorMessage_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_GetLastErrorMessage, "GetLastErrorMessage" }, // 1045534859
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_IsLoggingErrors, "IsLoggingErrors" }, // 610223152
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetErrorMessage, "SetErrorMessage" }, // 2975097948
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetLoggingErrorsEnabled, "SetLoggingErrorsEnabled" }, // 1954025567
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_LastErrorMessage = { "LastErrorMessage", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniPublicAPIObjectBase, LastErrorMessage), METADATA_PARAMS(Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_LastErrorMessage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_LastErrorMessage_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bHasError = { "bHasError", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniPublicAPIObjectBase), &Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bHasError_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bHasError_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bHasError_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bIsLoggingErrors = { "bIsLoggingErrors", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniPublicAPIObjectBase), &Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bIsLoggingErrors_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bIsLoggingErrors_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics::NewProp_bIsLoggingErrors_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniPublicAPIObjectBase, UHoudiniPublicAPIObjectBase::StaticClass, TEXT("UHoudiniPublicAPIObjectBase"), &Z_Registration_Info_UClass_UHoudiniPublicAPIObjectBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPublicAPIObjectBase), 1532807341U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_1953976095(TEXT("/Script/HoudiniEngineEditor"),
		Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h_Statics::EnumInfo));
