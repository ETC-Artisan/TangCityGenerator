...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniParameterDetails_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniParameterDetails_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniFloatRampCurve, UHoudiniFloatRampCurve::StaticClass, TEXT("UHoudiniFloatRampCurve"), &Z_Registration_Info_UClass_UHoudiniFloatRampCurve, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniFloatRampCurve), 2880687864U) },
		{ Z_Construct_UClass_UHoudiniColorRampCurve, UHoudiniColorRampCurve::StaticClass, TEXT("UHoudiniColorRampCurve"), &Z_Registration_Info_UClass_UHoudiniColorRampCurve, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniColorRampCurve), 2152620207U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniParameterDetails_h_3314746500(TEXT("/Script/HoudiniEngineEditor"),
		Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniParameterDetails_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniParameterDetails_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
