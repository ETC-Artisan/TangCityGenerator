...
class UScriptStruct* FHoudiniStringResolver::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HoudiniStringResolver.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniStringResolver, Z_Construct_UPackage__Script_HoudiniEngine(), TEXT("HoudiniStringResolver"));
	}
...
class UScriptStruct* FHoudiniAttributeResolver::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HoudiniAttributeResolver.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniAttributeResolver, Z_Construct_UPackage__Script_HoudiniEngine(), TEXT("HoudiniAttributeResolver"));
	}
...
template<> HOUDINIENGINE_API UScriptStruct* StaticStruct<FHoudiniAttributeResolver>()
{
	...
	struct Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniStringResolver_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniStringResolver_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniStringResolver_h_1639681956(TEXT("/Script/HoudiniEngine"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniStringResolver_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniStringResolver_h_Statics::ScriptStructInfo),
		nullptr, 0);
