...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_InputObject = { "InputObject", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputObject, InputObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_InputObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_InputObject_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputObject, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_Transform_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_Type_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputObject, Type), Z_Construct_UEnum_HoudiniEngineRuntime_EHoudiniInputObjectType, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_Type_MetaData)) }; // 4175023962
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bHasChanged = { "bHasChanged", nullptr, (EPropertyFlags)0x0020080000200000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniInputObject), &Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bHasChanged_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bHasChanged_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bHasChanged_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bTransformChanged = { "bTransformChanged", nullptr, (EPropertyFlags)0x0020080000200000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniInputObject), &Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bTransformChanged_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bTransformChanged_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bTransformChanged_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bImportAsReference = { "bImportAsReference", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniInputObject), &Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bImportAsReference_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bImportAsReference_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputObject_Statics::NewProp_bImportAsReference_MetaData)) };
#if WITH_METADATA
	...
	struct Z_Construct_UClass_UHoudiniInputStaticMesh_Statics
	{
		...
		static const UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_BlueprintStaticMeshes_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_BlueprintStaticMeshes_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_BlueprintStaticMeshes;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UECodeGen_Private::FClassParams ClassParams;
	};
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHoudiniInputStaticMesh_Statics::NewProp_BlueprintStaticMeshes_Inner = { "BlueprintStaticMeshes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UHoudiniInputObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHoudiniInputStaticMesh_Statics::NewProp_BlueprintStaticMeshes_MetaData[] = {
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniInputStaticMesh_Statics::NewProp_BlueprintStaticMeshes = { "BlueprintStaticMeshes", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputStaticMesh, BlueprintStaticMeshes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputStaticMesh_Statics::NewProp_BlueprintStaticMeshes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputStaticMesh_Statics::NewProp_BlueprintStaticMeshes_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UHoudiniInputStaticMesh_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHoudiniInputStaticMesh_Statics::NewProp_BlueprintStaticMeshes_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHoudiniInputStaticMesh_Statics::NewProp_BlueprintStaticMeshes,
	};
	...
	struct Z_Construct_UClass_UHoudiniInputMeshComponent_Statics
	{
		...
		static const UECodeGen_Private::FStrPropertyParams NewProp_MeshComponentsMaterials_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_MeshComponentsMaterials_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_MeshComponentsMaterials;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UECodeGen_Private::FClassParams ClassParams;
	};
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::NewProp_StaticMesh = { "StaticMesh", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputMeshComponent, StaticMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::NewProp_StaticMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::NewProp_StaticMesh_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::NewProp_MeshComponentsMaterials_Inner = { "MeshComponentsMaterials", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::NewProp_MeshComponentsMaterials_MetaData[] = {
		{ "Comment", "// Path to the materials assigned on the SMC\n" },
		{ "ModuleRelativePath", "Private/HoudiniInputObject.h" },
		{ "ToolTip", "Path to the materials assigned on the SMC" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::NewProp_MeshComponentsMaterials = { "MeshComponentsMaterials", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputMeshComponent, MeshComponentsMaterials), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::NewProp_MeshComponentsMaterials_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::NewProp_MeshComponentsMaterials_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::NewProp_MeshComponentsMaterials_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHoudiniInputMeshComponent_Statics::NewProp_MeshComponentsMaterials,
	};
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineResolution = { "SplineResolution", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputSplineComponent, SplineResolution), METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineResolution_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineResolution_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineClosed = { "SplineClosed", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniInputSplineComponent), &Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineClosed_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineClosed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineClosed_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineControlPoints_Inner = { "SplineControlPoints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineControlPoints = { "SplineControlPoints", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputSplineComponent, SplineControlPoints), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineControlPoints_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputSplineComponent_Statics::NewProp_SplineControlPoints_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniInputHoudiniSplineComponent_Statics::NewProp_Reversed = { "Reversed", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniInputHoudiniSplineComponent), &Z_Construct_UClass_UHoudiniInputHoudiniSplineComponent_Statics::NewProp_Reversed_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputHoudiniSplineComponent_Statics::NewProp_Reversed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputHoudiniSplineComponent_Statics::NewProp_Reversed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_FOV = { "FOV", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputCameraComponent, FOV), METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_FOV_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_FOV_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_AspectRatio = { "AspectRatio", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputCameraComponent, AspectRatio), METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_AspectRatio_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_AspectRatio_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_bIsOrthographic = { "bIsOrthographic", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UHoudiniInputCameraComponent), &Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_bIsOrthographic_SetBit, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_bIsOrthographic_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_bIsOrthographic_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_OrthoWidth = { "OrthoWidth", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputCameraComponent, OrthoWidth), METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_OrthoWidth_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_OrthoWidth_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_OrthoNearClipPlane = { "OrthoNearClipPlane", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputCameraComponent, OrthoNearClipPlane), METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_OrthoNearClipPlane_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_OrthoNearClipPlane_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_OrthoFarClipPlane = { "OrthoFarClipPlane", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputCameraComponent, OrthoFarClipPlane), METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_OrthoFarClipPlane_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputCameraComponent_Statics::NewProp_OrthoFarClipPlane_MetaData)) };
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UHoudiniInputHoudiniAsset_Statics::NewProp_AssetOutputIndex = { "AssetOutputIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputHoudiniAsset, AssetOutputIndex), METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputHoudiniAsset_Statics::NewProp_AssetOutputIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputHoudiniAsset_Statics::NewProp_AssetOutputIndex_MetaData)) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHoudiniInputActor_Statics::NewProp_ActorComponents_Inner = { "ActorComponents", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UHoudiniInputSceneComponent_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniInputLandscape_Statics::NewProp_CachedInputLandscapeTraqnsform = { "CachedInputLandscapeTraqnsform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputLandscape, CachedInputLandscapeTraqnsform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputLandscape_Statics::NewProp_CachedInputLandscapeTraqnsform_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputLandscape_Statics::NewProp_CachedInputLandscapeTraqnsform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UHoudiniInputLandscape_Statics::NewProp_CachedNumLandscapeComponents = { "CachedNumLandscapeComponents", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputLandscape, CachedNumLandscapeComponents), METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputLandscape_Statics::NewProp_CachedNumLandscapeComponents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputLandscape_Statics::NewProp_CachedNumLandscapeComponents_MetaData)) };
...
template<> HOUDINIENGINERUNTIME_API UScriptStruct* StaticStruct<FHoudiniBrushInfo>()
{
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_BrushActor = { "BrushActor", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHoudiniBrushInfo, BrushActor), Z_Construct_UClass_ABrush_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_BrushActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_BrushActor_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedTransform = { "CachedTransform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHoudiniBrushInfo, CachedTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedTransform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedOrigin = { "CachedOrigin", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHoudiniBrushInfo, CachedOrigin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedOrigin_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedOrigin_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedExtent = { "CachedExtent", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHoudiniBrushInfo, CachedExtent), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedExtent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedExtent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedBrushType = { "CachedBrushType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHoudiniBrushInfo, CachedBrushType), Z_Construct_UEnum_Engine_EBrushType, METADATA_PARAMS(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedBrushType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedBrushType_MetaData)) }; // 133554834
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFInt64PropertyParams Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedSurfaceHash = { "CachedSurfaceHash", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt64, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHoudiniBrushInfo, CachedSurfaceHash), METADATA_PARAMS(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedSurfaceHash_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewProp_CachedSurfaceHash_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniInputBrush_Statics::NewProp_BrushesInfo_Inner = { "BrushesInfo", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FHoudiniBrushInfo, METADATA_PARAMS(nullptr, 0) }; // 3153268224
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHoudiniInputBrush_Statics::NewProp_BrushesInfo_MetaData[] = {
		{ "ModuleRelativePath", "Private/HoudiniInputObject.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHoudiniInputBrush_Statics::NewProp_BrushesInfo = { "BrushesInfo", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputBrush, BrushesInfo), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputBrush_Statics::NewProp_BrushesInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputBrush_Statics::NewProp_BrushesInfo_MetaData)) }; // 3153268224
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHoudiniInputBrush_Statics::NewProp_CombinedModel_MetaData[] = {
		{ "ModuleRelativePath", "Private/HoudiniInputObject.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UHoudiniInputBrush_Statics::NewProp_CombinedModel = { "CombinedModel", nullptr, (EPropertyFlags)0x0020080000202000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHoudiniInputBrush, CombinedModel), Z_Construct_UClass_UModel, METADATA_PARAMS(Z_Construct_UClass_UHoudiniInputBrush_Statics::NewProp_CombinedModel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHoudiniInputBrush_Statics::NewProp_CombinedModel_MetaData)) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_Statics::EnumInfo[] = {
		{ EHoudiniInputObjectType_StaticEnum, TEXT("EHoudiniInputObjectType"), &Z_Registration_Info_UEnum_EHoudiniInputObjectType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4175023962U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_Statics::ScriptStructInfo[] = {
		{ FHoudiniBrushInfo::StaticStruct, Z_Construct_UScriptStruct_FHoudiniBrushInfo_Statics::NewStructOps, TEXT("HoudiniBrushInfo"), &Z_Registration_Info_UScriptStruct_HoudiniBrushInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniBrushInfo), 3153268224U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniInputObject, UHoudiniInputObject::StaticClass, TEXT("UHoudiniInputObject"), &Z_Registration_Info_UClass_UHoudiniInputObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputObject), 3260046829U) },
		{ Z_Construct_UClass_UHoudiniInputStaticMesh, UHoudiniInputStaticMesh::StaticClass, TEXT("UHoudiniInputStaticMesh"), &Z_Registration_Info_UClass_UHoudiniInputStaticMesh, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputStaticMesh), 113851430U) },
		{ Z_Construct_UClass_UHoudiniInputSkeletalMesh, UHoudiniInputSkeletalMesh::StaticClass, TEXT("UHoudiniInputSkeletalMesh"), &Z_Registration_Info_UClass_UHoudiniInputSkeletalMesh, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputSkeletalMesh), 2065658547U) },
		{ Z_Construct_UClass_UHoudiniInputGeometryCollection, UHoudiniInputGeometryCollection::StaticClass, TEXT("UHoudiniInputGeometryCollection"), &Z_Registration_Info_UClass_UHoudiniInputGeometryCollection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputGeometryCollection), 2408392980U) },
		{ Z_Construct_UClass_UHoudiniInputSceneComponent, UHoudiniInputSceneComponent::StaticClass, TEXT("UHoudiniInputSceneComponent"), &Z_Registration_Info_UClass_UHoudiniInputSceneComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputSceneComponent), 3823251077U) },
		{ Z_Construct_UClass_UHoudiniInputMeshComponent, UHoudiniInputMeshComponent::StaticClass, TEXT("UHoudiniInputMeshComponent"), &Z_Registration_Info_UClass_UHoudiniInputMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputMeshComponent), 2374725821U) },
		{ Z_Construct_UClass_UHoudiniInputInstancedMeshComponent, UHoudiniInputInstancedMeshComponent::StaticClass, TEXT("UHoudiniInputInstancedMeshComponent"), &Z_Registration_Info_UClass_UHoudiniInputInstancedMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputInstancedMeshComponent), 393836991U) },
		{ Z_Construct_UClass_UHoudiniInputSplineComponent, UHoudiniInputSplineComponent::StaticClass, TEXT("UHoudiniInputSplineComponent"), &Z_Registration_Info_UClass_UHoudiniInputSplineComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputSplineComponent), 975129591U) },
		{ Z_Construct_UClass_UHoudiniInputGeometryCollectionComponent, UHoudiniInputGeometryCollectionComponent::StaticClass, TEXT("UHoudiniInputGeometryCollectionComponent"), &Z_Registration_Info_UClass_UHoudiniInputGeometryCollectionComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputGeometryCollectionComponent), 3372114000U) },
		{ Z_Construct_UClass_UHoudiniInputSkeletalMeshComponent, UHoudiniInputSkeletalMeshComponent::StaticClass, TEXT("UHoudiniInputSkeletalMeshComponent"), &Z_Registration_Info_UClass_UHoudiniInputSkeletalMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputSkeletalMeshComponent), 2259915112U) },
		{ Z_Construct_UClass_UHoudiniInputHoudiniSplineComponent, UHoudiniInputHoudiniSplineComponent::StaticClass, TEXT("UHoudiniInputHoudiniSplineComponent"), &Z_Registration_Info_UClass_UHoudiniInputHoudiniSplineComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputHoudiniSplineComponent), 3735625565U) },
		{ Z_Construct_UClass_UHoudiniInputCameraComponent, UHoudiniInputCameraComponent::StaticClass, TEXT("UHoudiniInputCameraComponent"), &Z_Registration_Info_UClass_UHoudiniInputCameraComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputCameraComponent), 1344782634U) },
		{ Z_Construct_UClass_UHoudiniInputHoudiniAsset, UHoudiniInputHoudiniAsset::StaticClass, TEXT("UHoudiniInputHoudiniAsset"), &Z_Registration_Info_UClass_UHoudiniInputHoudiniAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputHoudiniAsset), 34011176U) },
		{ Z_Construct_UClass_UHoudiniInputActor, UHoudiniInputActor::StaticClass, TEXT("UHoudiniInputActor"), &Z_Registration_Info_UClass_UHoudiniInputActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputActor), 1554228752U) },
		{ Z_Construct_UClass_UHoudiniInputLandscape, UHoudiniInputLandscape::StaticClass, TEXT("UHoudiniInputLandscape"), &Z_Registration_Info_UClass_UHoudiniInputLandscape, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputLandscape), 427462444U) },
		{ Z_Construct_UClass_UHoudiniInputBrush, UHoudiniInputBrush::StaticClass, TEXT("UHoudiniInputBrush"), &Z_Registration_Info_UClass_UHoudiniInputBrush, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputBrush), 2024542153U) },
		{ Z_Construct_UClass_UHoudiniInputDataTable, UHoudiniInputDataTable::StaticClass, TEXT("UHoudiniInputDataTable"), &Z_Registration_Info_UClass_UHoudiniInputDataTable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputDataTable), 876188803U) },
		{ Z_Construct_UClass_UHoudiniInputFoliageType_InstancedStaticMesh, UHoudiniInputFoliageType_InstancedStaticMesh::StaticClass, TEXT("UHoudiniInputFoliageType_InstancedStaticMesh"), &Z_Registration_Info_UClass_UHoudiniInputFoliageType_InstancedStaticMesh, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniInputFoliageType_InstancedStaticMesh), 2633837888U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_1600919053(TEXT("/Script/HoudiniEngineRuntime"),
		Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputObject_h_Statics::EnumInfo));
