...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHoudiniPublicAPIBlueprintLib_GetAPI_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HoudiniPublicAPIBlueprintLib_eventGetAPI_Parms, ReturnValue), Z_Construct_UClass_UHoudiniPublicAPI_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHoudiniPublicAPIBlueprintLib_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHoudiniPublicAPIBlueprintLib_GetAPI, "GetAPI" }, // 604661392
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIBlueprintLib_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIBlueprintLib_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniPublicAPIBlueprintLib, UHoudiniPublicAPIBlueprintLib::StaticClass, TEXT("UHoudiniPublicAPIBlueprintLib"), &Z_Registration_Info_UClass_UHoudiniPublicAPIBlueprintLib, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPublicAPIBlueprintLib), 882483933U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIBlueprintLib_h_915000225(TEXT("/Script/HoudiniEngineEditor"),
		Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIBlueprintLib_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_TangCityGenerator_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIBlueprintLib_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
